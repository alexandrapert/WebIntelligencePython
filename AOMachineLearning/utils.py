...
def compute_xp(df,reference_data):
    # df contains the data for which the experience is computed
    # reference_data is the data in which the experience is searched
    P1_Experince = []
    P2_Experince = []
...
def compute_WL_ratio(df,reference_data):
    # df contains the data for which the ratio is computed
    # reference_data is the data in which the ratio is searched
    P1_WL_ratio = []
    P2_WL_ratio = []
...
def rename_handler(df):
    #  renames data in regards with the new format chosen (p1 and p2) 
...
def unwanted_handler(df):
    #giving mean values to NaN values
    df = df.fillna(df.mean())
    return df


def factorize_handler(df):
    # factorizing non numerical data 
